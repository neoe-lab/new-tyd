...
<head>
    ...
    <!-- Lineawesome CSS -->
    <link rel="stylesheet" href=<?= base_url("assets/backend/css/line-awesome.min.css")?>>
        ...
        <div class="header">
            ...
            <div class="header-left">
                <a href="index.html" class="logo">
                    <img src=<?= base_url("assets/backend/img/logo.png")?> width="40" height="40" alt="">
                </a>
            </div>
            <!-- /Logo -->
            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item dropdown has-arrow flag-nav">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
                        <img src=<?=base_url("assets/img/flags/us.png")?> alt="" height="20"> <span>English</span>
                    </a>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="la la-cube"></i> <span> แอพ</span> <span class="menu-arrow"></span></a>
                            <ul style="display: none;">
